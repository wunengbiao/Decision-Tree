...
VERSION := ${shell python -c "import os; os.chdir('DecisionTree'); import DecisionTree;print DecisionTree.__version__"}
...
#	pydoc -w DecisionTree
	pydoc -w DecisionTree/DecisionTree.py

help:
	open DecisionTree-${VERSION}.html
