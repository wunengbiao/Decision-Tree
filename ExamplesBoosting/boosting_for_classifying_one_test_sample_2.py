...
#   UNCOMMENT THE FOLLOWING TWO STATEMENTS if you would like to see the
#   classification result obtained with every decision tree in the cascade:
print("\nDisplaying the classification results obtained with all stages:\n")
